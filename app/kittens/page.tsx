    ...
    <section className="space-y-10">
      <div className="rounded-[2rem] border border-slate-200 bg-white p-8 shadow-soft">
        <div className="space-y-3">
          <p className="text-sm uppercase tracking-[0.3em] text-royal-700">Maine Coon kittens</p>
          <h1 className="text-3xl font-semibold text-slate-900">Purebred kittens available for adoption</h1>
          <p className="max-w-3xl text-slate-600">Filter by age, color, gender, and status. Every kitten is raised in a home environment and comes with full health assurances.</p>
        </div>
      </div>
