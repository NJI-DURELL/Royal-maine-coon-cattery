  ...
  return (
    <section className="mx-auto max-w-3xl rounded-[2rem] border border-slate-200 bg-white p-10 text-center shadow-soft">
      ...
      <div className="mt-8 rounded-[2rem] border border-amber-200 bg-amber-50 p-8">
        <p className="text-slate-900">Message from the breeder team: Please contact support at <a href={`mailto:${siteConfig.email}`} className="font-semibold text-royal-700">{siteConfig.email}</a> to appeal.</p>
      </div>
    </section>
  );
}
